...
[.anns]
* Current Agenda: link:#week0[Getting Started]
* link:assts/asst01.html[Assignment 01]: *Due January 25th*. 
...
| Office Hours - Prof. Normoyle | 200A | TBD, by appointment
| Office Hours - Jasmine | Park 231 | TBD 
| Office Hours - Synarah | Park 231 | TBD
