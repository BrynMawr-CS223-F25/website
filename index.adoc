...
* First lecture will be on Tuesday, September 3rd, 11:40AM in room Park 159.
* First assignment is Due Sept 6th. link:assts/asst01.html[Assignment 01: Hello C!]
* First lab will be on Thursday, September 5th, 2:40PM in Park 230. We will go over git and using Github
...
| Office Hours - Prof. Aline Normoyle | Park 200B | Fridays, 3-5 PM (see slack for exceptions)
| Office Hours - Paprika Chen | Park 231 | Tuesdays, 7-9 PM  
| Office Hours - Yue Chen | Park 231 | Thursdays, 7-9 PM
