...
* link:assts/asst07.html[Assignment 07] is due Dec 12th
* link:assts/lab-memory-f25.html[Lab: Visualizing malloc] is due Dec 9th
* Midterm II will be in-class Dec 4th. See link:studyguide4.html[Study Guide 4], link:studyguide5.html[Study Guide 5], link:studyguide6.html[Study Guide 6]
