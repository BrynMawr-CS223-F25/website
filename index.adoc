...
* Next assignment is Due Sept 20th. link:assts/asst03.html[Assignment 03: If you malloc something, set it free]
* Lab Quiz 1: link:studyguide1.html[Study Guide for Quiz 1]
