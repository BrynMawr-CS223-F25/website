...
The intensity I is given by the following formula.
...
is handled individually using the same formula. For example, for red 

[stem]
++++
R = \text{bucketsize} * floor(0.5 + \text{red} / \text{bucketsize});
++++
