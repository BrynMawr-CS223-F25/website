...
Click on the link:https://classroom.github.com/a/j7KZkNhy[link] and accept the pull request. Then, update your local repository. 
...
NOTE: You can also accept the pull request on Github from your repository (link:PullRequest.png[screenshot]). 
