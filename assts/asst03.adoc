...
In this multi-week assignment, you will build your VIM editor using the ncurses 
library. 
...
* Loading files from the command line (Should be finished by Tuesday, September 23)
* Quitting with `:q` (Should be finished by Tuesday, September 23)

Features (Due on Friday, September 26):
...
* Searching with '/'. Typing '/' will set the current search word. Pressing 'n' will go to the next match and pressing 'p' will go to the previous match. Note: A good data structure can make searching fast.
