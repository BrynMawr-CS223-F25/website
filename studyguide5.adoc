...
4) Draw the stack diagram for the following program with four threads.

[source]
----
----

5) Ann-marie has the following errors when she tries to build. What type of error is it (compile, link, runtime, or logical)? How can she fix it?
