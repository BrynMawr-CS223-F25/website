...
[source]
----
git@github.com:BrynMawr-CS223-F22/<YOUR_USERNAME>-final-exam-practice.git
----
...
[cols="1,1,1,1"]
|===
| amarmerada | ychen1 | cragobar | ddinh
| dsoemitro | bho | jfabiandub | jkang1
| jtorres | ssitaf | tduong | tfeshbach
| tchinzorig | | |
|===
